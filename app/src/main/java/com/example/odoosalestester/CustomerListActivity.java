...
public class CustomerListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listViewPartner = (ListView) findViewById(R.id.list_item_customer);
    ...
    public void onClickSearchPartner(View view) {
       refreshing();
    }

    private void refreshing(){
        EditText editKeyword = (EditText) findViewById(R.id.edt_search);
...
//                        "Position : " + itemPosition + " | ListItem : " + itemValue, Toast.LENGTH_LONG).show();
    ...
    public void onAddPartnerClick(View view) {
